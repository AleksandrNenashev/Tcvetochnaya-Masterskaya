...
//			}
        ...
        if (isset($this->request->post['config_autocalc_hash_url'])) {
            $data['config_autocalc_hash_url'] = $this->request->post['config_autocalc_hash_url'];
        } else {
            $data['config_autocalc_hash_url'] = $this->config->get('config_autocalc_hash_url');
        }
